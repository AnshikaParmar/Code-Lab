...
public class CaesarCipher_decrypt4 {

    private int key1;
    private int key2;

    // Constructor with keys
    public CaesarCipher_decrypt4(int key1, int key2) {
        this.key1 = key1;
        this.key2 = key2;
    }
    ...
    public static CaesarCipher_decrypt4 breakTwoKeyCipher(String encrypted) {
        ...
        return new CaesarCipher_decrypt4(key1, key2);
    }

    // Guess the key for a single string
    private static int getKey(String s) {
        int[] freqs = new CaesarCipher_decrypt4(0, 0).countLetters(s);
        int maxDex = new CaesarCipher_decrypt4(0, 0).maxIndex(freqs);
    ...
    public static void main(String[] args) {
        ...
        // Break the cipher
        CaesarCipher_decrypt4 cc = breakTwoKeyCipher(encrypted);
